...
```{r loadData}
setwd("~/Dropbox/02_RikenProj/fMRI_Data_R/MIData/")
MIdata_s01 <- read.csv('s01_MI_5orient.csv')
MIdata_s02 <- read.csv('s02_MI_5orient.csv')
MIdata_s03 <- read.csv('s03_MI_5orient.csv')
MIdata_s04 <- read.csv('s04_MI_5orient.csv')
MIdata_s05 <- read.csv('s05_MI_5orient.csv')
